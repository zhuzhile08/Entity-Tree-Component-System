...
private:
	...
	private:
		...
		public:
			...
			virtual void removeComponent(std::size_t) = 0;
...
public:
	...
	template <class Ty> static Archetype createSub(Archetype& archetype, std::size_t hash) {
		assert(!archetype.m_components.empty() && "etcs::detail::World::Archetype::createSub(): Cannot create subset archetype of empty archetype!");
